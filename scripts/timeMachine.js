export const currentDate = new Date("10-04-2023");
...
export const currentDateFormatted = `${currentDay
  .toString()
  .padStart(2, "0")}.${currentMonth.toString().padStart(2, "0")}`;
export const tomorrowsDateFormatted = `${tomorrowsDay
  .toString()
  .padStart(2, "0")}.${tomorrowsMonth.toString().padStart(2, "0")}`;

export const afterTomorrowsDayFormatted = `${afterTomorrowsDay
  .toString()
